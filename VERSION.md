...
| v1.2.0 | 2026-07-13 | RWD 手機平板支援、雙指縮放、表單全螢幕、篩選新增「無紀錄」、批次清除記錄、更名為清華蝴蝶園導覽統計系統、MIT 授權、GitHub Pages 部署 |
| v1.2.1 | 2026-07-22 | 系統更名"清華蝴蝶園導覽統計"、照片看完回表單修正、Toolbar 模式文字調整、頁面版本號顯示、輸出檔名 butterfly_garden.html |
